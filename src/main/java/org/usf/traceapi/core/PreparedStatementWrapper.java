...
public final class PreparedStatementWrapper implements PreparedStatement {
	...
	public boolean execute() throws SQLException {
		return tracer.execute(ps::execute);
	}
	...
	/**
	 * @see StatementWrapper : duplicated
	 */

	@Override
	public boolean execute(String sql) throws SQLException {
		return tracer.execute(()-> ps.execute(sql));
	}
	
	@Override
	public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
		return tracer.execute(()-> ps.execute(sql, autoGeneratedKeys));
	}
	
	@Override
	public boolean execute(String sql, int[] columnIndexes) throws SQLException {
		return tracer.execute(()-> ps.execute(sql, columnIndexes));
	}
	
	@Override
	public boolean execute(String sql, String[] columnNames) throws SQLException {
		return tracer.execute(()-> ps.execute(sql, columnNames));
	}
	...
	public ResultSet getResultSet() throws SQLException {
		return tracer.resultset(ps::getResultSet);
	}
