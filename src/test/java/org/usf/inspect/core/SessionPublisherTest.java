...
import static org.usf.inspect.core.EventTraceDispatcher.emit;
import static org.usf.inspect.core.EventTraceDispatcher.handlers;
import static org.usf.inspect.core.EventTraceDispatcher.register;
...
class SessionPublisherTest {
	...
	void testRegister(int n) {
		nParallelExec(n, ()-> registerHandler(s-> {}));
	...
	void testEmit(int n) {
		...
		for(var o : reg) {
			registerHandler(s-> o.incrementAndGet());
		}
